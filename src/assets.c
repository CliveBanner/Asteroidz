...
void Asset_GenerateStep(AppState *s) {
  ...
  if (s->assets_generated < PLANET_COUNT) {
    ...
    s->textures.planet_textures[s->assets_generated] = SDL_CreateTexture(s->renderer, SDL_PIXELFORMAT_ABGR8888, SDL_TEXTUREACCESS_STATIC, sz, sz);
    SDL_SetTextureBlendMode(s->textures.planet_textures[s->assets_generated], SDL_BLENDMODE_BLEND);
    SDL_SetTextureScaleMode(s->textures.planet_textures[s->assets_generated], SDL_SCALEMODE_NEAREST);
    SDL_UpdateTexture(s->textures.planet_textures[s->assets_generated], NULL, p, sz * 4); SDL_free(p);
    ...
    s->textures.galaxy_textures[g_idx] = SDL_CreateTexture(s->renderer, SDL_PIXELFORMAT_ABGR8888, SDL_TEXTUREACCESS_STATIC, sz, sz);
    SDL_SetTextureBlendMode(s->textures.galaxy_textures[g_idx], SDL_BLENDMODE_BLEND);
    SDL_SetTextureScaleMode(s->textures.galaxy_textures[g_idx], SDL_SCALEMODE_NEAREST);
    SDL_UpdateTexture(s->textures.galaxy_textures[g_idx], NULL, p, sz * 4); SDL_free(p);
    ...
    s->textures.asteroid_textures[a_idx] = SDL_CreateTexture(s->renderer, SDL_PIXELFORMAT_ABGR8888, SDL_TEXTUREACCESS_STATIC, sz, sz);
    SDL_SetTextureBlendMode(s->textures.asteroid_textures[a_idx], SDL_BLENDMODE_BLEND);
    SDL_SetTextureScaleMode(s->textures.asteroid_textures[a_idx], SDL_SCALEMODE_NEAREST);
    SDL_UpdateTexture(s->textures.asteroid_textures[a_idx], NULL, p, sz * 4); SDL_free(p);
    ...
    s->textures.debris_textures[d_idx] = SDL_CreateTexture(s->renderer, SDL_PIXELFORMAT_ABGR8888, SDL_TEXTUREACCESS_STATIC, sz, sz);
    SDL_SetTextureBlendMode(s->textures.debris_textures[d_idx], SDL_BLENDMODE_BLEND);
    SDL_SetTextureScaleMode(s->textures.debris_textures[d_idx], SDL_SCALEMODE_NEAREST);
    SDL_UpdateTexture(s->textures.debris_textures[d_idx], NULL, p, sz * 4); SDL_free(p);
